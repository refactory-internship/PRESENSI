                    ...
                    <div class="card shadow p-4">
                        <nav>
                            <div class="nav nav-tabs" role="tablist">
                                <a class="nav-link active" aria-current="page" href="{{ route('web.profile') }}">Profile</a>
                                <a class="nav-link" href="{{ route('web.profile.password') }}">Password</a>
                            </div>
                        </nav>
                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                <div class="tab-pane fade show active" role="tabpanel">
                                    @include('auth.profile.forms.profile')
                                </div>
                            </div>
                        </div>
                    </div>
